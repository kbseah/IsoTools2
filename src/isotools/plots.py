...
def triangle_plot(str_var_tab, ax=None, colors=None, tax_title=None, alpha=0.7):
    """
    ...
    :param ax: Plot on existing axes
    ...
    :param tax_title: Title for the ternary axis plot
    :param alpha: Alpha value for scatter plot points
    """
    ...
    for gn in groups:
        ...
        tax.scatter(
            vals.to_numpy()[:, [2, 1, 0]], color=color_scheme[gn], alpha=alpha, label=gn
        )
